package com.microservicos.cloud.controller;
...
import com.microservicos.cloud.service.ProdutoService;
...
public class ProdutoController {
	...
	public ProdutoDTO findById(@PathVariable("id")  Long id) {
		...
		public ProdutoDTO create(@RequestBody ProdutoDTO produtoDTO) {
			ProdutoDTO produtoAlterado = produtoService.create(produtoDTO);
			produtoAlterado.add(linkTo(methodOn(ProdutoController.class).findById(produtoAlterado.getId())).withSelfRel());
		...
		public ProdutoDTO update(@RequestBody ProdutoDTO produtoDTO) {
			ProdutoDTO produtoAlterado = produtoService.update(produtoDTO);
